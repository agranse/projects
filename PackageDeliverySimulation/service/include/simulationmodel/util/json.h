...
class JsonValue {
 public:
  ...
  /**
   * @brief Destructor for JsonValue
   */
  ~JsonValue();
...
inline JsonValue::~JsonValue() {
  ...
  /**
   * @brief Copy constructor for JsonValue object
   * @param other type JsonValue& contains object to be copied
   */
inline JsonValue::JsonValue(const JsonValue& other) {
  ...
  /**
   * @brief Copy assignment operator for JsonValue object
   * @param other type const JsonValue& of whose content is to be copied
   */
inline JsonValue& JsonValue::operator=(const JsonValue& other) {
  ...
  /**
   * @brief Move constructor for JsonValue object
   * @param other type JsonValue&& contains object to be moved from
   */
...
inline JsonValue& JsonValue::operator=(JsonValue&& other) noexcept {
  ...
  /**
   * @brief Creates a JsonValue object from a reference to a picojson::value
   * @param v type picojson::value& contains a reference to the picojson::value to create the JsonValue from
   * @return A JsonValue object representing the picojson::value as a reference
   */
inline JsonValue JsonValue::fromReference(picojson::value& v) {
  ...
  /**
   * @brief Operator= which assigns value of JsonObject to JsonValue
   * @param o type const JsonObject& contains value to be assigned
   * @return A reference to JsonValue object after assignment
   */
inline JsonValue& JsonValue::operator=(const JsonObject& o) {
  ...
  /**
   * @brief Conversion operator to convert JsonValue to JsonObject
   * @return A JsonObject made from picojson::object of JsonValue
   */
inline JsonValue::operator JsonObject() const {
  return {get<picojson::object>()};
}
  /**
   * @brief Assign the values of JsonArray to JsonValue
   * @param a type const JsonArray& contains JsonArray of whose value is to be assigned
   */
inline JsonValue& JsonValue::operator=(const JsonArray& a) {
  ...
  /**
   * @brief Converts JsonValue to JsonArray
   * @return JsonArray created from picojson::array of JsonValue
   */
inline JsonValue::operator JsonArray() const {
  return {get<picojson::array>()};
}
  /**
   * @brief Constructs JsonValue object from JsonObject
   * @param o type JsonObject& contains JsonObject used to construct JsonValue
   */
inline JsonValue::JsonValue(const JsonObject& o) : v(o.getObject()) {}
  /**
   * @brief Constructs JsonValue object from JsonArray
   * @param o type JsonArray& contains JsonArray used to construct JsonValue
   */
inline JsonValue::JsonValue(const JsonArray& a) : v(a.getArray()) {}
  /**
   * @brief Gets keys of JsonObject
   * @return Vector of strings containing keys of JsonObject
   */
...
/**
 * @brief Operator overload for writing to a stream for JsonValue.
 * @param os type std::ostream& containing output stream to write to
 * @param val type const JsonValue& containing JsonValue to output
...
/**
 * @brief Operator overload for writing to a stream for JsonObject.
 * @param os type std::ostream& containing output stream to write to
 * @param obj type const JsonValue& containing JsonObject to output
 * @return Output stream
 */
...
/**
 * @brief Operator overload for writing to a stream for JsonArray.
 * @param os type std::ostream& containing output stream to write to
 * @param array type const JsonValue& containing JsonArray to output
 * @return Output stream
 */
